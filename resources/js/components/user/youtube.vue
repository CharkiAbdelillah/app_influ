					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Nombre d’abonnés: </b>{{user1.youtube.nombre_abonne}}</p>
								<p><b>Moyenne des likes: </b>{{user1.youtube.like}}</p>
								<p><b>Moyenne des commentaires: </b>{{user1.youtube.commentaire}}</p>
								<p><b>Taille par rapport aux followers: </b>{{user1.youtube.followers}}</p>
								<p><b>Qualité d’audience: </b>{{user1.youtube.qualite}}</p>
								<p><b>Engagement: </b>{{user1.youtube.engagement}}</p>
