				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{asset('user/images/home/logo.png')}}" alt="" /></a>
						</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="{{asset('user/images/home/slide1.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{asset('user/images/home/social-media.png')}}"  class="pricing" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<img src=""{{asset('user/images/home/slide2.png')}}" class="girl img-responsive" alt="" />
									<img src=""{{asset('user/images/home/social-media.png')}}"  class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{asset('user/images/home/slide3.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{asset('user/images/home/social-media.png')}}" class="pricing" alt="" />
								</div>
							</div>
