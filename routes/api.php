...
Route::middleware('api')->resource('/personne','PersonneController')->only(['index','show','store','create','destroy']);
...
Route::middleware('api')->resource('/personneTypeInstagram','InstagrameController')->only(['index','show','store','create']);
